                    ...
                    <?php if ($_SESSION['usuario_rol'] === 'admin'): ?>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownAdmin">
                                ...
                                <li><a class="dropdown-item" href="php/agregarProducto.php">Agregar productos nuevos</a></li>
                                <li><a class="dropdown-item" href="php/modificarProducto.php">Modificar productos</a></li>
